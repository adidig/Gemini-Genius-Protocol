...
To make this protocol your permanent AI setting, copy the text inside the box below, send it to Gemini, and ask it to: **"Save this as my default response protocol."**
...
כדי שהפרוטוקול יהפוך להגדרה הקבועה שלכם, העתיקו את הטקסט שבתוך המירכאות למטה, שלחו אותו ל-Gemini ובקשו ממנו: **"שמור את הטקסט הבא בתור הגדרת הדיפולט (Default) הקבועה שלי."**
