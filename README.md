...
* **Integrity:** External links and plugins are disabled to maintain speed.
...
### איך מגדירים את הפרוטוקול?

1. היכנסו לקובץ ה-txt ב-Repository הזה [Gemini-Genius-Protocol.txt](./Gemini-Genius-Protocol.txt) להעתקה נקייה.
2. העתיקו את תוכן הקובץ (קוד ה"מוח").
3. בתוך Gemini, עברו ל**הגדרות** -> **המידע שג'ימיני זוכר** (Saved Info).
4. **הדביקו** את הטקסט ושמרו.

**שימו לב:** קוד הפרוטוקול כתוב באנגלית לביצועים מקסימליים, אך אם שפת הממשק שלכם היא עברית, Gemini יזהה זאת ויענה לכם בעברית מלאה באופן אוטומטי.
